...
export default defineComponent({
  ...
  setup() {
    const anchors = [
      { title: 'О кафедре', select: '#about' },
      { title: 'Направления', select: '#direction' },
      { title: 'Абитуриенту', select: '#entrant' },
      { title: 'Состав кафедры', select: '#teachers' },
      { title: 'Контакты', select: '#contact' },
    ];
