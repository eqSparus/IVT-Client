...
import TheModalChangeEntrantItem from '@/components/modals/entrant/TheModalChangeEntrantItem.vue';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const update = async () => {
      ...
      const data = await putEntrant(changeEntrant.value, changeEntrant.value.id as string);
