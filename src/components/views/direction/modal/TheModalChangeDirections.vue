...
import AppModalDirectionsItem from '@/components/views/direction/modal/AppModalDirectionsItem.vue';
import AppPlusMinusButton from '@/components/UI/AppPlusMinusButton.vue';
import TheModalDirectionAdd from '@/components/views/direction/modal/TheModalDirectionAdd.vue';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const updateDirect = async (direction: Direction) => {
